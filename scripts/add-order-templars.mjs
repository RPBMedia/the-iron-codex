...
const templars = {
  ...
  sigilImage: fp('Cross of the Knights Templar.svg'),
  sigilImageInfo: {
    caption: 'The red cross of the Knights Templar.',
    source: 'Wikimedia Commons',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Cross_of_the_Knights_Templar.svg',
    note: 'A red cross on a white mantle marked the brothers as men ready for martyrdom.'
  },
  summary:
  ...
  purpose:
    'Founded to protect Christian pilgrims on the roads to Jerusalem after the First Crusade, the Templars became a standing army of warrior-monks defending the Crusader states and the pilgrim routes. Sworn to poverty, chastity, and obedience, they fused monastic life with holy war — and bankrolled that war through a pan-European network of estates and finance.',
  ...
  relatedEntries: {
    ...
    orders: [
      ...
      ord('order-of-montjoy', 'Order of Montjoy', 'A small order absorbed into the Temple in 1188')
    ]
  }
}
